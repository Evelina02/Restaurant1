...
<c:choose>
  <c:when test="${sessionScope.role == null}">
    ...
    <li><a href="${pageContext.request.contextPath}/Controller?command=all_reviews">${reviews_text}</a></li>
   ...
   <c:otherwise>
	   <c:choose>
    	   <c:when test="${sessionScope.role =='CLIENT'}">
             ...
             <li><a href="${pageContext.request.contextPath}/Controller?command=profile">${profile_text}</a></li>
     		 <li><a href="${pageContext.request.contextPath}/Controller?command=all_user_orders">${all_user_orders_text}</a></li>
          
           </c:when>
           <c:when test="${sessionScope.role =='ADMIN'}">
             <li><a href="${pageContext.request.contextPath}/index.jsp">${restaurant_name}</a></li>
             <li><a href="${pageContext.request.contextPath}/Controller?command=profile">${profile_text}</a></li>
      		 <li><a href="${pageContext.request.contextPath}/Controller?command=all_orders">${orders_text}</a></li>
             <li><a href="${pageContext.request.contextPath}/Controller?command=all_users">${users_text}</a></li>
             <li><a href="${pageContext.request.contextPath}/Controller?command=admin_menu">${menu_text}</a></li> 
           </c:when>
       </c:choose>
